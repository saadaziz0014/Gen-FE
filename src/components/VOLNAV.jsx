...
const Volunteer_NavBar = ({ navBar2, showCase1Page }) => {
  ...
  useEffect(() => {
    ...
    if (!Cookies.get("role") || Cookies.get("role") != "volunteer") {
      toast({
        title: "Only Volunteer Allowed",
        status: "error",
        duration: 2000,
        isClosable: true,
        position: "top",
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Link onClick={scrollToTop} to="/volunteer/volunteer">
            <img
...
export default Volunteer_NavBar;
