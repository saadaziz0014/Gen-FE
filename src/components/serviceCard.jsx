  ...
  return (
    ...
    >
      <img
        ...
        alt={imgSrc}
      />
      <div className="w-full h-full absolute bg-blue-400/50"></div>
      <div className="it-container px-4 w-full h-full absolute text-white hover:bg-orange-400 transition-all duration-500 flex flex-col justify-center items-center gap-2">
        ...
        <Link
          to={`/Services/${id}`}
          onClick={scrollToTop}
          className="it-content text-xl mt-10 font-semibold  opacity-0 scale-y-0 transition-all duration-75 origin-top hover:text-blue-400"
        >
