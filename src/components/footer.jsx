      ...
      >
        <div className="flex flex-col items-start h-auto justify-between gap-16 w-2/4 max-lg:w-full pr-10 max-sm:pr-0">
          <div className="flex flex-col text-lg items-start  justify-between gap-10 ">
            <a href="/">
              <img src="/GEN-Serve.png" className="w-36" alt="GEN-Serve" />
            </a>
            <p style={{ color: "#696969" }}>
              Connect and make a differnce in your community!
            </p>
            <div className="flex text-xl justify-start items-center gap-10 text-orange-400">
          ...
          <p style={{ color: "#696969" }}>© GEN Serve. All Rights Reserved 2023.</p>
        </div>
