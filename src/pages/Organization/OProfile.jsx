                    ...
                    <div className={`${options[0].selected == true ? 'block' : 'hidden'}`}>
                        ...
                        <div className="flex gap-2">
                            <div className="mt-3">
                                ...
                                <a href="#Category" className="inline underline ml-2 text-sky-500">
                                    Categories
                                </a>
                            </div>
                        </div>
                            ...
                            <form>
                                <div className="flex flex-col gap-2 mt-2">
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <select name="" id="" className="border p-1" value={category} onChange={(e) => setCategory(e.target.value)}>
                                    ...
                                    <div className="grid grid-cols-2 gap-2 mt-3">
                                        {user && user.categories.map((cat) => (
                                            <button className="bg-blue-600 rounded-lg text-white" key={cat._id}>{cat.name}</button>
                                        ))}
                                    </div>
                                    <div className="flex justify-end">
                                        <button
